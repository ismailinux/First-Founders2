...
// Updated portfolio companies with imported assets
const portfolioCompanies = [
  { name: "PocketLawyers", description: "PocketLawyers is Africa’s first fully integrative legal tech startup that offers access to affordable premium legal services and solutions to SMEs and Startups.", category: "LegalTech", year: 2019, initial: "PL", logo: pocketLawyersLogo },
  { name: "Paysonet", description: "Fintech company dedicated to making digital payments easy and accessible, by providing tailored digital financial solutions to empower market women and business owners, helping them to conduct business and process payments without any hassle.", category: "Fintech", year: 2020, initial: "  PS", logo: paysonetLogo },
  { name: "Escape", description: "A digital wallet payment solution, simplifying payments to improve lives.", category: "Fintech", year: 2018, initial: "ES", logo: escapeLogo },
  { name: "PayAfta", description: "We offer you the safest way to pay for your online purchases. With Payafta, your money is held securely until you receive your goods or services as promised. Trust is at the core of what we do, and your peace of mind is our priority.", category: "Fintech", year: 2021, initial: "PA", logo: payaftaLogo },
  { name: "Wiggo", description: "Wiggo is a travel financing platform that makes it easier for travellers to plan, save and pay for their travels.", category: "Travel", year: 2019, initial: "WG", logo: wiggoLogo },
  { name: "Tappit", description: "Tappit is a revolutionary fintech app that harnesses the power of Near Field Communication (NFC) technology, allowing users to make seamless and secure payments using their mobile devices.", category: "Fintech", year: 2020, initial: "TP", logo: tappitLogo },
];
